		...
		<section>
			<div class="card card-cascade narrower z-depth-0">
				<div class="view view-cascade gradient-card-header blue-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-center align-items-center">
					<a href="{{ route('admin.category.index') }}" class="white-text m-2">Categories</a>
					<a href="{{ route('admin.category.create') }}" type="button" class="btn btn-outline-white btn-rounded btn-sm px-2 waves-effect waves-light align-self-end"><i class="fas fa-plus mt-0"></i></a>
				</div>
				...
				<div class="px-4">
					<div class="table-responsive">
						...
						<table id="dtMaterialDesignExample" class="table table-hover mb-0">
							...
							<thead>
							<tr>
								<th class="th-lg"><a># <i class="fas fa-sort ml-1"></i></a></th>
								<th class="th-lg"><a>Name <i class="fas fa-sort ml-1"></i></a></th>
								<th class="th-lg"><a>Parent<i class="fas fa-sort ml-1"></i></a></th>
							...
							@foreach( $categories as $category)
								...
								<tr class='clickable-row'>
									...
									<td>{{ $category->name }}</td>
									<td>{{ $category->parent()->first() ? $category->parent()->first()->name : ''}}</td>
									<td>
										<a href="{{ route('admin.category.show', $category->id) }}" class="btn btn-primary">
